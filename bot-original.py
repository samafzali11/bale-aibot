...
TOKEN = "321244632:_hAOHeyIqc4dKLVia4YuomqaNaQQjfdiJf0"
SUPPORT_ID = 1596192209
CHANNEL_ID = "@aibotchannel"
DB_FILE = "bot-database.db"
BASE_URL = "https://tapi.bale.ai/bot"
HF_CLIENT = OpenAI(
    base_url="https://router.huggingface.co/v1",
    api_key="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",
)
SYSTEM_PROMPT = """
تو یک دوست صمیمی، باهوش و کمک‌ کننده هستی.
با لحن گرم، مهربان و کمی شوخ‌ طبع حرف بزن.
هر سوالی پرسید، با حوصله، دقیق و مفید جواب بده.
از ایموجی هم گاهی استفاده کن که صمیمی‌ تر باشه 😊
هر موضوعی بود با مهربانی کامل جواب بده.
"""
...
async def check_membership(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("کانال هوش مصنوعی", url=f"https://ble.ir/aibotchannel")],
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if data in ["lang_fa", "lang_en"]:
            ...
            text = translate(user_id,
                             "الان می‌ تونی هر سؤالی داری تایپ کنی، هوش مصنوعی جواب میده 😊\nبرای خروج:",
...
async def ai_chat(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(
            translate(user_id,
                      "یه اتفاق غیر منتظره افتاد... دوباره بگو ببینم چی بود؟ 😅",
...
def main():
    ...
    app.add_handler(MessageHandler(filters.ALL & ~filters.COMMAND, collect_messages), group=0)
